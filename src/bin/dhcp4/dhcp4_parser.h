...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    TOKEN_NEVER_SEND = 351,        // "never-send"
    TOKEN_RECORD_TYPES = 352,      // "record-types"
    TOKEN_ENCAPSULATE = 353,       // "encapsulate"
    TOKEN_ARRAY = 354,             // "array"
    TOKEN_PARKED_PACKET_LIMIT = 355, // "parked-packet-limit"
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_NEVER_SEND = 96,                       // "never-send"
        S_RECORD_TYPES = 97,                     // "record-types"
        S_ENCAPSULATE = 98,                      // "encapsulate"
        S_ARRAY = 99,                            // "array"
        S_PARKED_PACKET_LIMIT = 100,             // "parked-packet-limit"
        ...
        S_early_global_reservations_lookup = 286, // early_global_reservations_lookup
        S_ip_reservations_unique = 287,          // ip_reservations_unique
        S_reservations_lookup_first = 288,       // reservations_lookup_first
        S_interfaces_config = 289,               // interfaces_config
        S_290_26 = 290,                          // $@26
        S_interfaces_config_params = 291,        // interfaces_config_params
        S_interfaces_config_param = 292,         // interfaces_config_param
        S_sub_interfaces4 = 293,                 // sub_interfaces4
        S_294_27 = 294,                          // $@27
        S_interfaces_list = 295,                 // interfaces_list
        S_296_28 = 296,                          // $@28
        S_dhcp_socket_type = 297,                // dhcp_socket_type
        S_298_29 = 298,                          // $@29
        S_socket_type = 299,                     // socket_type
        S_outbound_interface = 300,              // outbound_interface
        S_301_30 = 301,                          // $@30
        S_outbound_interface_value = 302,        // outbound_interface_value
        S_re_detect = 303,                       // re_detect
        S_service_sockets_require_all = 304,     // service_sockets_require_all
        S_service_sockets_retry_wait_time = 305, // service_sockets_retry_wait_time
        S_service_sockets_max_retries = 306,     // service_sockets_max_retries
        S_lease_database = 307,                  // lease_database
        S_308_31 = 308,                          // $@31
        S_sanity_checks = 309,                   // sanity_checks
        S_310_32 = 310,                          // $@32
        S_sanity_checks_params = 311,            // sanity_checks_params
        S_sanity_checks_param = 312,             // sanity_checks_param
        S_lease_checks = 313,                    // lease_checks
        S_314_33 = 314,                          // $@33
        S_extended_info_checks = 315,            // extended_info_checks
        S_316_34 = 316,                          // $@34
        S_hosts_database = 317,                  // hosts_database
        S_318_35 = 318,                          // $@35
        S_hosts_databases = 319,                 // hosts_databases
        S_320_36 = 320,                          // $@36
        S_database_list = 321,                   // database_list
        S_not_empty_database_list = 322,         // not_empty_database_list
        S_database = 323,                        // database
        S_324_37 = 324,                          // $@37
        S_database_map_params = 325,             // database_map_params
        S_database_map_param = 326,              // database_map_param
        S_database_type = 327,                   // database_type
        S_328_38 = 328,                          // $@38
        S_db_type = 329,                         // db_type
        S_user = 330,                            // user
        S_331_39 = 331,                          // $@39
        S_password = 332,                        // password
        S_333_40 = 333,                          // $@40
        S_host = 334,                            // host
        S_335_41 = 335,                          // $@41
        S_port = 336,                            // port
        S_name = 337,                            // name
        S_338_42 = 338,                          // $@42
        S_persist = 339,                         // persist
        S_lfc_interval = 340,                    // lfc_interval
        S_readonly = 341,                        // readonly
        S_connect_timeout = 342,                 // connect_timeout
        ...
        S_option_data_never_send = 480,          // option_data_never_send
        ...
        S_next_server = 508,                     // next_server
        S_509_90 = 509,                          // $@90
        S_server_hostname = 510,                 // server_hostname
        S_511_91 = 511,                          // $@91
        S_boot_file_name = 512,                  // boot_file_name
        S_513_92 = 513,                          // $@92
        S_ip_address = 514,                      // ip_address
        S_515_93 = 515,                          // $@93
        S_ip_addresses = 516,                    // ip_addresses
        S_517_94 = 517,                          // $@94
        S_duid = 518,                            // duid
        S_519_95 = 519,                          // $@95
        S_hw_address = 520,                      // hw_address
        S_521_96 = 521,                          // $@96
        S_client_id_value = 522,                 // client_id_value
        S_523_97 = 523,                          // $@97
        S_circuit_id_value = 524,                // circuit_id_value
        S_525_98 = 525,                          // $@98
        S_flex_id_value = 526,                   // flex_id_value
        S_527_99 = 527,                          // $@99
        S_hostname = 528,                        // hostname
        S_529_100 = 529,                         // $@100
        S_reservation_client_classes = 530,      // reservation_client_classes
        S_531_101 = 531,                         // $@101
        S_relay = 532,                           // relay
        S_533_102 = 533,                         // $@102
        S_relay_map = 534,                       // relay_map
        S_client_classes = 535,                  // client_classes
        S_536_103 = 536,                         // $@103
        S_client_classes_list = 537,             // client_classes_list
        S_client_class_entry = 538,              // client_class_entry
        S_539_104 = 539,                         // $@104
        S_client_class_params = 540,             // client_class_params
        S_not_empty_client_class_params = 541,   // not_empty_client_class_params
        S_client_class_param = 542,              // client_class_param
        S_client_class_name = 543,               // client_class_name
        S_client_class_test = 544,               // client_class_test
        S_545_105 = 545,                         // $@105
        S_client_class_template_test = 546,      // client_class_template_test
        S_547_106 = 547,                         // $@106
        S_only_if_required = 548,                // only_if_required
        S_dhcp4o6_port = 549,                    // dhcp4o6_port
        S_control_socket = 550,                  // control_socket
        S_551_107 = 551,                         // $@107
        S_control_socket_params = 552,           // control_socket_params
        S_control_socket_param = 553,            // control_socket_param
        S_control_socket_type = 554,             // control_socket_type
        S_555_108 = 555,                         // $@108
        S_control_socket_name = 556,             // control_socket_name
        S_557_109 = 557,                         // $@109
        S_dhcp_queue_control = 558,              // dhcp_queue_control
        S_559_110 = 559,                         // $@110
        S_queue_control_params = 560,            // queue_control_params
        S_queue_control_param = 561,             // queue_control_param
        S_enable_queue = 562,                    // enable_queue
        S_queue_type = 563,                      // queue_type
        S_564_111 = 564,                         // $@111
        S_capacity = 565,                        // capacity
        S_arbitrary_map_entry = 566,             // arbitrary_map_entry
        S_567_112 = 567,                         // $@112
        S_dhcp_ddns = 568,                       // dhcp_ddns
        S_569_113 = 569,                         // $@113
        S_sub_dhcp_ddns = 570,                   // sub_dhcp_ddns
        S_571_114 = 571,                         // $@114
        S_dhcp_ddns_params = 572,                // dhcp_ddns_params
        S_dhcp_ddns_param = 573,                 // dhcp_ddns_param
        S_enable_updates = 574,                  // enable_updates
        ...
        S_586_118 = 586,                         // $@118
        S_dep_qualifying_suffix = 587,           // dep_qualifying_suffix
        S_588_119 = 588,                         // $@119
        S_dep_override_no_update = 589,          // dep_override_no_update
        S_dep_override_client_update = 590,      // dep_override_client_update
        S_dep_replace_client_name = 591,         // dep_replace_client_name
        S_592_120 = 592,                         // $@120
        S_dep_generated_prefix = 593,            // dep_generated_prefix
        S_594_121 = 594,                         // $@121
        S_dep_hostname_char_set = 595,           // dep_hostname_char_set
        S_596_122 = 596,                         // $@122
        S_dep_hostname_char_replacement = 597,   // dep_hostname_char_replacement
        S_598_123 = 598,                         // $@123
        S_config_control = 599,                  // config_control
        S_600_124 = 600,                         // $@124
        S_sub_config_control = 601,              // sub_config_control
        S_602_125 = 602,                         // $@125
        S_config_control_params = 603,           // config_control_params
        S_config_control_param = 604,            // config_control_param
        S_config_databases = 605,                // config_databases
        S_606_126 = 606,                         // $@126
        S_config_fetch_wait_time = 607,          // config_fetch_wait_time
        S_loggers = 608,                         // loggers
        S_609_127 = 609,                         // $@127
        S_loggers_entries = 610,                 // loggers_entries
        S_logger_entry = 611,                    // logger_entry
        S_612_128 = 612,                         // $@128
        S_logger_params = 613,                   // logger_params
        S_logger_param = 614,                    // logger_param
        S_debuglevel = 615,                      // debuglevel
        S_severity = 616,                        // severity
        S_617_129 = 617,                         // $@129
        S_output_options_list = 618,             // output_options_list
        S_619_130 = 619,                         // $@130
        S_output_options_list_content = 620,     // output_options_list_content
        S_output_entry = 621,                    // output_entry
        S_622_131 = 622,                         // $@131
        S_output_params_list = 623,              // output_params_list
        S_output_params = 624,                   // output_params
        S_output = 625,                          // output
        S_626_132 = 626,                         // $@132
        S_flush = 627,                           // flush
        S_maxsize = 628,                         // maxsize
        S_maxver = 629,                          // maxver
        S_pattern = 630,                         // pattern
        S_631_133 = 631,                         // $@133
        S_compatibility = 632,                   // compatibility
        S_633_134 = 633,                         // $@134
        S_compatibility_params = 634,            // compatibility_params
        S_compatibility_param = 635,             // compatibility_param
        S_lenient_option_parsing = 636,          // lenient_option_parsing
        S_637_ignore_rai_link_selection = 637    // ignore-rai-link-selection
      };
    };
...
switch (yykind)
  ...
  private:
    ...
    enum
    {
      yylast_ = 1272,     ///< Last index in yytable_.
