...
/// functions in the pre process hook library. In order to test the load
...
/// @brief Test fixture for testing loading and unloading the pre-process library
class PreProcessLibLoadTest : public isc::test::LibLoadTest {
public:
    /// @brief Constructor
    PreProcessLibLoadTest() : LibLoadTest(PRE_PROCESS_LIB_SO) {
    }

    /// @brief Destructor
    virtual ~PreProcessLibLoadTest() {
    }
