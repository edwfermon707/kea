...
/// @file This file contains tests which verify sub-option pre processing.
...
class PreProcessSubTest : public BasePreProcessTest { };

// Verify that the sub-options configuration must be a list.
TEST_F(PreProcessSubTest, configNotList) {
...
TEST_F(PreProcessSubTest, configEmpty) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, noSubOptionConfig) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigNotMap) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, configMultipleAction) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
...
TEST_F(PreProcessSubTest, subOptionConfigUnknown) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigNoCodeName) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigNoSpace) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadCode4) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadCode6) {
...
TEST_F(PreProcessSubTest, subOptionConfigBadSpace) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigInvalidSpace) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadName) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigEmptyName) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigUnknownName) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigUnknownCodeNoCSVFormat) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigUnknownCodeDisableCSVFormat) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigUnknownCodeEnableCSVFormat) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigDefinedName) {
...
TEST_F(PreProcessSubTest, subOptionConfigLastResortName) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-option", 222,
...
// resort space.
TEST_F(PreProcessSubTest, subOptionConfigLastResortCode) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VENDOR_ENCAPSULATED_OPTIONS);
...
TEST_F(PreProcessSubTest, subOptionConfigVendorName) {
    CfgMgr::instance().setFamily(AF_INET6);
...
// vendor space.
TEST_F(PreProcessSubTest, subOptionConfigVendorCode) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subOptionConfigDosSISName) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
...
// vendor space.
TEST_F(PreProcessSubTest, subOptionConfigDosSISCode) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VIVSO_SUBOPTIONS);
...
TEST_F(PreProcessSubTest, subOptionConfigCodeNameMismatch) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VIVSO_SUBOPTIONS);
...
TEST_F(PreProcessSubTest, subOptionConfigBadCSVFormat) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadContainerAdd) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadContainerRemove) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigMultipleAction) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigAddNotString) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigEmptyAdd) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadAdd) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigSupersedeNotString) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigEmptySupersede) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadSupersede) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigRemoveNotString) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigEmptyRemove) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigBadRemove) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
...
TEST_F(PreProcessSubTest, subOptionConfigComplex) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(109);
    ...
    EXPECT_EQ(1, map.count(109));
    auto smap = map[109];
    PreProcessImpl::SubOptionConfigPtr sub_cfg;
    ASSERT_NO_THROW(sub_cfg = smap.at(1));
    ASSERT_TRUE(sub_cfg);
    EXPECT_EQ(1, sub_cfg->getCode());
    EXPECT_EQ(PreProcessImpl::ADD, sub_cfg->getAction());
    EXPECT_EQ(PreProcessImpl::ADD, sub_cfg->getContainerAction());
    ...
    EXPECT_EQ(PreProcessImpl::SUPERSEDE, sub_cfg->getAction());
    EXPECT_EQ(PreProcessImpl::NONE, sub_cfg->getContainerAction());
    ...
    EXPECT_EQ(PreProcessImpl::REMOVE, sub_cfg->getAction());
    EXPECT_EQ(PreProcessImpl::REMOVE, sub_cfg->getContainerAction());
...
TEST_F(PreProcessSubTest, subProcessNone) {
    auto rai_def = LibDHCP::getOptionDef(DHCP4_OPTION_SPACE,
                                         DHO_DHCP_AGENT_OPTIONS);
    PreProcessImpl::OptionConfigPtr
        opt_cfg(new PreProcessImpl::OptionConfig(DHO_DHCP_AGENT_OPTIONS,
                                                 rai_def));
    // RAI_OPTION_AGENT_CIRCUIT_ID is 1 but has no definition.
    OptionDefinitionPtr def;
    PreProcessImpl::SubOptionConfigPtr
        sub_cfg(new PreProcessImpl::SubOptionConfig(1, def, opt_cfg));
...
TEST_F(PreProcessSubTest, subProcessAddEnableCSVFormat) {
    OptionDefSpaceContainer defs;
    ...
    Pkt4Ptr query(new Pkt4(DHCPDISCOVER, 12345));
    EXPECT_FALSE(query->getOption(222));
...
TEST_F(PreProcessSubTest, subProcessAddNoContainer) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessAddDisableCSVFormat) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessAdd) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
    ...
    EXPECT_EQ(1, query->options_.count(222));
...
TEST_F(PreProcessSubTest, subProcessAddExisting) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessAddEmpty) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessAdd43) {
    OptionDefSpaceContainer defs;
    ...
    OptionPtr opt = query->getOption(DHO_VENDOR_ENCAPSULATED_OPTIONS);
    ASSERT_TRUE(opt);
...
TEST_F(PreProcessSubTest, subProcessAddDocSISVIVSO) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VIVSO_SUBOPTIONS);
    ...
    OptionPtr opt = query->getOption(DHO_VIVSO_SUBOPTIONS);
    ASSERT_TRUE(opt);
...
TEST_F(PreProcessSubTest, subProcessAddDocSISVendorOps) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessAddVivso) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
...
TEST_F(PreProcessSubTest, subProcessAddVivsoMismatch) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  "vendor-123456", "string"));
    defs.addItem(sdef);
...
TEST_F(PreProcessSubTest, subProcessAddVendorOpts) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessAddVendorOptsMismatch) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessSupersedeEnableCSVFormat) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessSupersedeNoContainer) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessSupersedeDisableCSVFormat) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
// existing container option.
TEST_F(PreProcessSubTest, subProcessSupersede) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessSupersedeExisting) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessSupersedeEmpty) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessSupersede43) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  VENDOR_ENCAPSULATED_OPTION_SPACE,
                                                  "string"));
...
TEST_F(PreProcessSubTest, subProcessSupersedeDocSISVIVSO) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VIVSO_SUBOPTIONS);
...
TEST_F(PreProcessSubTest, subProcessSupersedeDocSISVendorOps) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessSupersedeVivso) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  "vendor-123456", "string"));
    defs.addItem(sdef);
...
TEST_F(PreProcessSubTest, subProcessSupersedeVivsoMismatch) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  "vendor-123456", "string"));
    defs.addItem(sdef);
...
TEST_F(PreProcessSubTest, subProcessSupersedeVendorOpts) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessSupersedeVendorOptsMismatch) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessRemove) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessRemoveLeaveContainer) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessRemoveContainerNotEmpty) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessRemoveContainerNoSubOption) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessRemoveFalse) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr def(new OptionDefinition("my-container", 222,
                                                 DHCP4_OPTION_SPACE, "empty",
                                                 "my-space"));
...
TEST_F(PreProcessSubTest, subProcessRemove43) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  VENDOR_ENCAPSULATED_OPTION_SPACE,
                                                  "string"));
    ...
    query->addOption(container);
    EXPECT_TRUE(query->getOption(DHO_VENDOR_ENCAPSULATED_OPTIONS));
    OptionStringPtr str(new OptionString(Option::V4, 1, "abc"));
    container->addOption(str);
    ...
    EXPECT_EQ(txt, query->toText());
    EXPECT_FALSE(query->getOption(DHO_VENDOR_ENCAPSULATED_OPTIONS));
}

// Verify that REMOVE action can handle DocSIS Vivso.
TEST_F(PreProcessSubTest, subProcessRemoveDocSISVIVSO) {
    ElementPtr options = Element::createList();
    ElementPtr option = Element::createMap();
    options->add(option);
    ElementPtr code = Element::create(DHO_VIVSO_SUBOPTIONS);
    ...
    EXPECT_EQ(txt, query->toText());
    EXPECT_FALSE(query->getOption(DHO_VIVSO_SUBOPTIONS));
}

// Verify that REMOVE action can handle DocSIS vendor-opts.
TEST_F(PreProcessSubTest, subProcessRemoveDocSISVendorOps) {
    CfgMgr::instance().setFamily(AF_INET6);
    ...
    OptionStringPtr str(new OptionString(Option::V6, DOCSIS3_V6_VENDOR_NAME,
                                         "foobar"));
    vendor->addOption(str);
    EXPECT_TRUE(query->getOption(D6O_VENDOR_OPTS));

    EXPECT_NO_THROW(impl_->process<Pkt6Ptr>(Option::V6, query));

    EXPECT_EQ(txt, query->toText());
    EXPECT_FALSE(query->getOption(D6O_VENDOR_OPTS));
}

// Verify that REMOVE action can handle the Vivso option.
TEST_F(PreProcessSubTest, subProcessRemoveVivso) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  "vendor-123456", "string"));
    defs.addItem(sdef);
    ...
    vendor->addOption(str);
    EXPECT_TRUE(query->getOption(DHO_VIVSO_SUBOPTIONS));
...
TEST_F(PreProcessSubTest, subProcessRemoveVivsoMismatch) {
    OptionDefSpaceContainer defs;
    OptionDefinitionPtr sdef(new OptionDefinition("my-option", 1,
                                                  "vendor-123456", "string"));
    defs.addItem(sdef);
...
TEST_F(PreProcessSubTest, subProcessRemoveVendorOpts) {
    CfgMgr::instance().setFamily(AF_INET6);
...
TEST_F(PreProcessSubTest, subProcessRemoveVendorOptsMismatch) {
    CfgMgr::instance().setFamily(AF_INET6);
